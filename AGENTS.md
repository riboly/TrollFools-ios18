...
- The Build 269 app-start trust-restoration workaround was reverted. The user confirmed that an updated Dopamine RootHide restores the required trust after a full restart, and the unchanged Build 268 injection continues to launch normally without opening TrollFools first. Keep the product version and injection code at `4.3-268` unless a separate TrollFools defect is demonstrated.
