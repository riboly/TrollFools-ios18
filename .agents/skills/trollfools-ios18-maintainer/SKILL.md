...
- Build 269's app-start trust-restoration workaround was reverted after the user confirmed that an updated Dopamine RootHide restores the required trust across a full restart. Keep TrollFools at Build 268 and do not reintroduce app-start restoration unless a current environment reproduces missing trust independently of Dopamine.
